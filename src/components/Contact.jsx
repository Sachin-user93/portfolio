...
//         // ----- CRITICAL: Enter your Web3 Forms Access key here ---------
//         // Go to https://web3forms.com/ to get your free key
...
//     return (
//         <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 style={{ backgroundImage: \url(${footerBg})` }} bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">

//             <h4 className="text-center mb-2 text-lg font-Ovo">Connect with me</h4>
//             <h2 className="text-center text-5xl font-Ovo">Get in touch</h2>
            
//             <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
//                 I'd love to hear from you! Whether you have a question about my projects, a job opportunity, or just want to say hi.
//             </p>

//             <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
//                 {/* FIXED: Changed value from "Eliana Jade" to your name */}
//                 <input type="hidden" name="subject" value="Sachin Ahirwar - New Portfolio Contact" />
...
export default function Contact() {
    ...
    const onSubmit = async (event) => {
        ...
        // Make sure you have your Access Key here
        formData.append("access_key", "YOUR_ACCESS_KEY_HERE");
    ...
    return (
        // FIXED: Removed the Tailwind 'bg-[url...]' class and used inline style with the full path
        <div id="contact" 
             className="w-full px-[12%] py-10 scroll-mt-20 bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none"
             style={{ backgroundImage: "url('/portfolio/assets/footer-bg-color.png')" }}>
            ...
            <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
                <input type="hidden" name="subject" value="Sachin Portfolio Contact" />
