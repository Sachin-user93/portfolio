...
export default function About() {
    // I am keeping the tools list safe. 
    // If you don't have images for 'firebase' or 'figma', the site might show a broken icon. 
    // Ideally, you should replace those images in your assets folder with React or Node icons.
    const tools = [
        { name: 'vscode', icon: './assets/vscode.png', },
        { name: 'mongodb', icon: './assets/mongodb.png', },
        { name: 'git', icon: './assets/git.png', },
        // Kept these to maintain layout, but you can remove them if you don't use them
    ...
    const data = [
        {
            ...
            // UPDATED: Your specific languages from the resume
            description: 'C, Java, Python, ReactJS, Node.js, Express',
        },
        {
            name: 'Education',
            icon1: './assets/edu-icon.png',
            icon2: './assets/edu-icon-dark.png',
            // UPDATED: Your University and Degree
            description: 'B.Tech in CSE, Dr. Hari Singh Gour University',
        },
        {
            name: 'Projects',
            icon1: './assets/project-icon.png',
            icon2: './assets/project-icon-dark.png',
            // UPDATED: Focused on your areas of interest
            description: 'Full Stack Web Apps & Generative AI',
        },
    ];
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    {/* Make sure you replace user-image.png with your own photo later! */}
                ...
                <div className="flex-1">
                    {/* UPDATED: Your specific Resume Summary */}
                    <p className="mb-10 max-w-2xl font-Ovo">
                        Enthusiastic Full Stack Developer with a love for JavaScript, React, and Node.js. I enjoy crafting dynamic web applications and diving into the world of AI. Always up for a challenge, especially when it involves cubes or exploring the latest tech trends.
                    </p>
